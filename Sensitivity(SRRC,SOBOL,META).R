...
#################################################################
setwd("C:/Users/ehdna/OneDrive - konkuk.ac.kr/학술발표대회/2022_동계학술발표대회/Sensitivity Analysis/Sensitivity_Results")
...
write.csv(TOTAL_Results,"All_Truncated_sensitivity_Results_20220924.csv")
